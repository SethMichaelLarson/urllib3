...
CHAIN_CERTS = {
    'certfile': os.path.join(CERTS_PATH, 'chain', 'server.chain.crt'),
    'keyfile': os.path.join(CERTS_PATH, 'chain', 'server.chain.key')
}
...
DEFAULT_CHAIN_CA = os.path.join(CERTS_PATH, 'cacert.chain.crt')
